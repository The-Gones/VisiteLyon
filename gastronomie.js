...
const sitesList = [
    {
      ...
      description: "<span>Assurement une des plus belles tables de Lyon.Le restaurant de Christian Têtedoie nous propose une cuisine gastronomique prestigieuse.</span> <span>Certainly one of the most beautiful restaurants in Lyon. Christian Têtedoie\'s restaurant offers prestigious gourmet cuisine.</span>",
    },
    {
      id:2,
      ...
      description: "<span>Comment dérire un monumemt tel que Monsieur Paul ? Sa disparition il y a 2 ans a laissé un grand vide a Collonges mais le flambeau a vite été repris et la famille reste aux commandes.</span><span>How to describe a monument such as Monsieur Paul? His disappearance 2 years ago left a great void in Collonges but the torch was quickly picked up and the family remains in charge</span>"
    },
    {
      id:3,
      ...
      description: "<span>Un restaurant de copain pour une cuisine simple mais recomfortante.</span><span>A friend's restaurant for simple but comforting cuisine</span>"
    },
    {
      id:4,
      ...
      description: "<span>Ahhhh les celebres bouchons lyonnais, si tu as 50 ans et que tu n'as pas mis les pieds dans un bouchon c'est que tu as raté ta vie !</span><span>Ahhhh the famous Bouchons Lyonnais, if you are 50 years old and you have not been in a Bouchon Lyonnais you have missed part of your life!</span>"
    },
  ];
